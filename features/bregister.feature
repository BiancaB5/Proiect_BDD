Feature: Registration page
  ...
  Scenario: Register new account with valid data
    When I enter "Ana" in the first name input
    When I enter "Cosanzeana" in the last name input
    And I enter random email adress in the email input
    And I enter "Ana12345" in the password input
    And  I enter "Ana12345" in the password confirm input
